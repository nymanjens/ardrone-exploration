...
export CFLAGS="$ARCH $SDK -mmacosx-version-min=10.5 -m32"
export CXXFLAGS="$ARCH $SDK -mmacosx-version-min=10.5 -m32"
export CPPFLAGS="$ARCH $SDK -mmacosx-version-min=10.5 -m32"
